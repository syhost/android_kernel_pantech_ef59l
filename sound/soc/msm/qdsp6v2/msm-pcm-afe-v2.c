...
#if 1 // 20131212 [PATCH] ASoC :msm: Increase Proxy buffering related case number : 01372878
#define MIN_CAPTURE_NUM_PERIODS (64 * 2)
#define MAX_CAPTURE_NUM_PERIODS (768 * 2)
#else
