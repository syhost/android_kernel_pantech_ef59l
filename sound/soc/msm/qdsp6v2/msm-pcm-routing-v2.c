...
#ifdef CONFIG_PANTECH_SND_QSOUND //20120618 jhsong : audio effect in open dsp  //FEATURE_PANTECH_SND_QSOUND_OPEN_DSP
...
int get_dai_mm(void){
		...
		//printk("###>>> %s, aud_session : %d\n", __func__, aud_session);
        return aud_session;
}
...
int get_aud_lpa_session_id(void){
		...
		//printk("###>>> %s, aud_session_id : %d\n", __func__, aud_session_id);
