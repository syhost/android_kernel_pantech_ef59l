...
#define PANTECH_AUDIO_EQ_MODE_CTL                               _IOW(PANTECH_AUDIO_IOCTL_MAGIC, 1, unsigned) //0x40047a01
...
#define PANTECH_AUDIO_GET_PRESET_NUM_CTL		_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 14, unsigned)
#define PANTECH_AUDIO_GET_PRESET_CTL			_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 15, unsigned)
#define PANTECH_AUDIO_GET_PRESET_NAME_CTL		_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 16, unsigned)
...
#define PANTECH_AUDIO_EXCITER_MODE_CTL			_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 36, unsigned)
#define PANTECH_AUDIO_EXCITER_VALUE_CTL			_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 37, unsigned)
#define PANTECH_AUDIO_EXCITER_KEEP_VAL_CTL		_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 38, unsigned)
