...
static struct wcd9xxx_mbhc_config mbhc_cfg = {
	...
	.gpio = 0,
	.gpio_irq = 0,
/* 2013-04-23 LS1@SND Modification based on BSP 1023(See the wcd9xxx_insert_detect_setup() of wcd9xxx-mbhc.c) */
...
#if defined(CONFIG_PANTECH_SND_BOOTUP_HEADSET_INFO)
	SOC_ENUM_EXT("Headset Status", msm_snd_enum[7], headset_status_get,
			headset_status_set),
#endif
};
