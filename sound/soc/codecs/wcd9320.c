...
static void msm8974_vega_Piezo_spk_amp_init(bool on)
{
       int ret = 0;

       if(Piezo_amp_onoff == on) return;
	else Piezo_amp_onoff = on;
...
#if defined (CONFIG_MACH_MSM8974_EF60S) || defined (CONFIG_MACH_MSM8974_EF61K) || defined (CONFIG_MACH_MSM8974_EF62L)
              msm8974_vega_Piezo_spk_amp_init(1);
#endif
		break;
	case SND_SOC_DAPM_POST_PMD:
#if defined (CONFIG_MACH_MSM8974_EF60S) || defined (CONFIG_MACH_MSM8974_EF61K) || defined (CONFIG_MACH_MSM8974_EF62L)
              msm8974_vega_Piezo_spk_amp_init(0);
#endif
...
/* 2013-06-19 LS1@SND It doesn't need to enable regulator because we got VDD_SPKDRV from battery
...
#if defined(CONFIG_PANTECH_SND_EF56S_HW) || defined(CONFIG_PANTECH_SND_EF59SKL_HW)
	TAIKO_REG_VAL(TAIKO_A_CDC_RX7_B4_CTL, 0x9),	// 2012-07-12 LS1@SND H/W (KimGyuTae) request(HPF 4HZ -> 75Hz) 
#else
...
/*
 * 2013-07-26 LS1@SND Impedance detection feature not used for removing pop-up noise.
