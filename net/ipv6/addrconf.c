...
#define ACONF_DEBUG 3 // FEATURE_LGT_DS_OPTIMIZE_IPV6_ASSIGNMENT_CRASH_FIX
...
#ifdef FEATURE_LGT_DS_OPTIMIZE_IPV6_ASSIGNMENT
	      ...
	      int scope, u32 flags)
{
    ...
    && !(addr_type & IPV6_ADDR_LINKLOCAL) )
   {
	...
	//spin_unlock(&addrconf_hash_lock); //FEATURE_LGT_DS_OPTIMIZE_IPV6_ASSIGNMENT_CRASH_FIX
...
//	spin_unlock_bh(&addrconf_hash_lock); //FEATURE_LGT_DS_OPTIMIZE_IPV6_ASSIGNMENT_CRASH_FIX
...
static int addrconf_ifdown(struct net_device *dev, int how)
{
	...
	spin_lock_bh(&addrconf_hash_lock); // FEATURE_LGT_DS_OPTIMIZE_IPV6_ASSIGNMENT_CRASH_FIX
