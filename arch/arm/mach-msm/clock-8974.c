...
static struct branch_clk camss_micro_ahb_clk = {
	...
	.has_sibling = 1,
#ifdef CONFIG_PANTECH_CAMERA  // patch for case #01393584, 2013-12-20	
...
static struct clk_lookup msm_clocks_8974[] = {
  ...
  CLK_LOOKUP("iface_clk", gcc_blsp1_ahb_clk.c, ""),
#elif defined(FEATURE_PANTECH_CONSOLE_UART1)
...
#if ((defined(T_EF56S) || defined(T_EF57K) || defined(T_EF58L)) && (BOARD_VER < WS20)) || (defined(T_EF59S) || defined(T_EF59K) || defined(T_EF59L) || defined(T_EF60S) || defined(T_EF61K) || defined(T_EF62L))
...
#if (BOARD_VER <= WS20) &&  (defined(T_EF56S) || defined(T_EF57K) || defined(T_EF58L))
	...
	CLK_LOOKUP("core_clk", gcc_blsp1_qup5_i2c_apps_clk.c, "f9927000.i2c"),
#else
#ifndef CONFIG_PANTECH_PMIC_FUELGAUGE_MAX17058
	...
	CLK_LOOKUP("iface_clk", gcc_blsp2_ahb_clk.c, "f9965000.i2c"), // p11309 BLSP9 - for LED Driver
#endif
#if defined(CONFIG_FB_MSM_MDSS_HDMI_MHL_SII8240)
	CLK_LOOKUP("iface_clk", gcc_blsp2_ahb_clk.c, "f9965000.i2c"), // p16008 BLSP9 - for MHL Driver 
#endif
#ifdef CONFIG_MACH_MSM8974_NAMI
	CLK_LOOKUP("iface_clk", gcc_blsp2_ahb_clk.c, "f9964000.i2c"), // p16008 BLSP9 - for LED Driver 	///LM3530	
#else
...
#if defined(CONFIG_SKY_DMB_SPI_HW) && (((defined(T_EF56S) || defined(T_EF57K) || defined(T_EF58L)) && (BOARD_VER > WS20)) || ((defined(T_EF59S) || defined(T_EF59K) || defined(T_EF59L)) && (BOARD_VER >= WS10)) || (defined(T_NAMI) && (BOARD_VER >= PT20))) || defined(T_EF60S) || (defined(T_EF61K) || defined(T_EF62L))
	CLK_LOOKUP("iface_clk", gcc_blsp1_ahb_clk.c, "f9923000.spi"), //BLSP1(BSLP1_QUP0) DMB_SPI
#else // BOARD_VER < TP10
	CLK_LOOKUP("iface_clk",  gcc_blsp2_ahb_clk.c, "f9966000.spi"), //BLSP10(BSLP2_QUP3) DMB_SPI
#endif	
...
#ifdef CONFIG_MACH_MSM8974_NAMI
	CLK_LOOKUP("core_clk", gcc_blsp2_qup2_i2c_apps_clk.c, "f9964000.i2c"),		///LM3530
#else
	CLK_LOOKUP("core_clk", gcc_blsp2_qup2_spi_apps_clk.c, "f9964000.spi"), //p11774 BLSP8 BTP_SPI
#endif
#if defined(CONFIG_LEDS_LP5523)
	CLK_LOOKUP("core_clk", gcc_blsp2_qup3_i2c_apps_clk.c, "f9965000.i2c"),	// p11309 BLSP9 - for LED Driver
#elif defined(CONFIG_FB_MSM_MDSS_HDMI_MHL_SII8240)
	CLK_LOOKUP("core_clk", gcc_blsp2_qup3_i2c_apps_clk.c, "f9965000.i2c"),	// p16008 BLSP9 - for MHL Driver			
#else
...
#if defined(CONFIG_SKY_DMB_SPI_HW) && (((defined(T_EF56S) || defined(T_EF57K) || defined(T_EF58L)) && (BOARD_VER > WS20)) || ((defined(T_EF59S) || defined(T_EF59K) || defined(T_EF59L)) && (BOARD_VER >= WS10)) || (defined(T_NAMI) && (BOARD_VER >= PT20)) || defined(T_EF60S) || (defined(T_EF61K) || defined(T_EF62L)))
	CLK_LOOKUP("core_clk", gcc_blsp1_qup1_spi_apps_clk.c, "f9923000.spi"), //BLSP1(BSLP1_QUP0) DMB_SPI
#else // BOARD_VER < TP10
	CLK_LOOKUP("core_clk", gcc_blsp2_qup4_spi_apps_clk.c, "f9966000.spi"), //BLSP10(BSLP2_QUP3) DMB_SPI
#endif	
...
#if defined(CONFIG_SKY_DMB_PMIC_19200) || defined(T_NAMI)  // wgon test
    CLK_LOOKUP("xo", cxo_a1.c, "dmb_spi"),
#endif
	/* MM sensor clocks */
	...
	/* CSID clocks */
#ifdef CONFIG_PANTECH_CAMERA // case#01169476 simultaneous camera
	CLK_LOOKUP("ispif_ahb_clk", camss_ispif_ahb_clk.c,
					"fda08000.qcom,csid"),
#endif
	CLK_LOOKUP("camss_top_ahb_clk", camss_top_ahb_clk.c,
...
#ifdef CONFIG_PANTECH_CAMERA//VFE0 reset timeout issue			   
	CLK_LOOKUP("csi1_src_clk", csi1_clk_src.c, "fda0a000.qcom,ispif"), 
	CLK_LOOKUP("csi1_clk", camss_csi1_clk.c, "fda0a000.qcom,ispif"), 
	...
	CLK_LOOKUP("csi2_src_clk", csi2_clk_src.c, "fda0a000.qcom,ispif"), 
	CLK_LOOKUP("csi2_clk", camss_csi2_clk.c, "fda0a000.qcom,ispif"), 
	...
	CLK_LOOKUP("csi3_src_clk", csi3_clk_src.c, "fda0a000.qcom,ispif"), 
	CLK_LOOKUP("csi3_clk", camss_csi3_clk.c, "fda0a000.qcom,ispif"), 
