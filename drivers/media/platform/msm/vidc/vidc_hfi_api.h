...
#ifdef FEATURE_PANTECH_MMP_QCOM_CR //for FW V20. VP8. Decode Only frames.        
...
struct vidc_hal_ebd {
	...
	u32 timestamp_lo;
	u32 flags;
#ifdef FEATURE_PANTECH_MMP_QCOM_CR //Case#1189486[CR# 487885] :  Handling High Profile (Unsupported)
	u32 status;
#endif	
	u32 mark_target;
	u32 mark_data;
