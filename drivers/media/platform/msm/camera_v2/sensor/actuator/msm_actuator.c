...
#include "msm_cci.h"
#ifdef CONFIG_PANTECH_CAMERA_ACT_QUP
...
#ifdef F_PANTECH_CAMERA_TUNING	//kai, 0709
static bool is_initialized = FALSE;
static int init_lens_pos = 0; // 20131128, wjh
static int init_step_pos = 0;
	...
	const struct i2c_device_id *id)
{
	...
	act_ctrl_t->cam_name = act_ctrl_t->subdev_id;   // jjhwang
	...
	snprintf(act_ctrl_t->msm_sd.sd.name, sizeof(act_ctrl_t->msm_sd.sd.name),
		"%s", "msm_actuator"/*id->name jjhwang*/);
#else
	snprintf(act_ctrl_t->msm_sd.sd.name, sizeof(act_ctrl_t->msm_sd.sd.name),
...
#ifndef CONFIG_PANTECH_CAMERA_ACT_QUP
...
#ifdef CONFIG_PANTECH_CAMERA_ACT_QUP
	{"qcom,actuator", (kernel_ulong_t)&msm_actuator_t},
#else
