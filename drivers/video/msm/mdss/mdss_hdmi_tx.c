...
extern int GetMHLHPDStatus(void);
#endif
...
#if (defined(CONFIG_FB_MSM_MDSS_HDMI_MHL_SII8240) && defined (CONFIG_MACH_MSM8974_NAMI))
	///////////////////////////////////////////////////////////////
	//// Check MHL Connection . ??	
	if(!GetMHLHPDStatus())
	{
		pr_info("MHL  HPD is not setted\n");
		return; 
	}
#endif	
	if (hdmi_ctrl->hpd_state) {
...
#if (defined(CONFIG_FB_MSM_MDSS_HDMI_MHL_SII8240) && defined (CONFIG_MACH_MSM8974_NAMI))
	hdcp_disabled=1;		///NAMI use Sii8240 which it has HDCP logic.so we don't use MSM8974's HDCP.
#else
	...
	enum hdmi_tx_power_module_type module, int enable)
{
	...
	if (enable) {
		...
		pr_info("power_data->gpio_config,power_data->num_gpio=%d\n",power_data->num_gpio);
...
#if (defined(CONFIG_FB_MSM_MDSS_HDMI_MHL_SII8240) && defined (CONFIG_MACH_MSM8974_NAMI))	
	pr_info("%s:hdmi_ctrl->hpd_feature_on=%d on\n", __func__,hdmi_ctrl->hpd_feature_on);
	////////////////////////////////////////////////////////////////////////////////////	
	///Test 
	pr_info("call queue_work!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
