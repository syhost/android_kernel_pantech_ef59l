...
#define DumpEdidBlock(override,pData,length) DumpEdidBlockImpl(__FILE__,__LINE__,override,(uint8_t *)pData,length);
#else //)(
#define DumpEdidBlock(override,pData,length) /* nothing to do */
#endif //)
