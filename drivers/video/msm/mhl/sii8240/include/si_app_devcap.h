...
#define DEVCAP_VAL_MHL_VERSION     MHL_VERSION
#define DEVCAP_VAL_DEV_CAT         (MHL_DEV_CAT_SOURCE /*| MHL_DEV_CATEGORY_POW_BIT */)
//<ZORO_MHL>#define DEVCAP_VAL_ADOPTER_ID_H    (uint8_t)(SILICON_IMAGE_ADOPTER_ID >>   8)
//<ZORO_MHL>#define DEVCAP_VAL_ADOPTER_ID_L    (uint8_t)(SILICON_IMAGE_ADOPTER_ID & 0xFF)
#define DEVCAP_VAL_ADOPTER_ID_H    (uint8_t)(PMC_ADOPTER_ID >>   8)
#define DEVCAP_VAL_ADOPTER_ID_L    (uint8_t)(PMC_ADOPTER_ID & 0xFF)
//<ZORO_MHL>#define DEVCAP_VAL_VID_LINK_MODE   (MHL_DEV_VID_LINK_SUPPRGB444)
#define DEVCAP_VAL_VID_LINK_MODE   (MHL_DEV_VID_LINK_SUPPRGB444 | MHL_DEV_VID_LINK_SUPP_PPIXEL)
#define DEVCAP_VAL_AUD_LINK_MODE   MHL_DEV_AUD_LINK_2CH
#define DEVCAP_VAL_VIDEO_TYPE      0
#define DEVCAP_VAL_LOG_DEV_MAP     MHL_LOGICAL_DEVICE_MAP
//<ZORO_MHL>#define DEVCAP_VAL_BANDWIDTH       0
#define DEVCAP_VAL_BANDWIDTH       15
#if 0 //<ZORO_MHL>
#define DEVCAP_VAL_FEATURE_FLAG    ( \
