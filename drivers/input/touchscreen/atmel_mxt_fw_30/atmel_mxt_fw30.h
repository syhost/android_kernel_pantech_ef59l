...
typedef enum{
	PAN_GOLDREFERENCE_BOOT_INIT = -1,       // Booting
	PAN_GOLDREFERENCE_NO_FLAG_AND_GR_ON,      // There are GR and Flag
	PAN_GOLDREFERENCE_FLAG_ON_AND_GR_ON,    // GR OK and Function Flag on
	PAN_GOLDREFERENCE_NO_FLAG_AND_NO_GR,    // NO Function flag(PCDT TOOL CHECK) and NO GR
	PAN_GOLDREFERENCE_FLAG_ON_BUT_NO_GR,    // Function flag On But No GR
}pan_goldreference_state;
...
//++ p11309 - 2013.05.14 for gold reference T66
  TOUCH_IOCTL_HALL_IC_GPIO_GET,         //P13106 for reading hall-ic gpio state
	...
	TOUCH_IOCTL_GLD_REF_GET_GOLDREFERENCE_ON_STATE = 7006,
//++ p11309 - 2013.07.19 Check Noise Mode shake
