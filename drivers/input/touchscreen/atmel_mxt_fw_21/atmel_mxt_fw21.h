...
#define PAN_TOUCH_DEBUG_ALL_MASK                0x000000FF
...
#define MXT_FIRMUP_ENABLE		// mxt_fw21 chipset firmware update enable
...
/* -------------------------------------------------------------------- */
/* mxt_fw21_config location defination */ 
/* -------------------------------------------------------------------- */
...
#define MXT_FW21_MAX_CHANNEL_NUM	540
#define MXT_FW21_DELTA_MODE			  0x10
#define MXT_FW21_REFERENCE_MODE		0x11
...
//++ p11309 - 2013.05.14 for gold reference T66
	TOUCH_IOCTL_GLD_REF_DO_CAL			= 7001,
	TOUCH_IOCTL_GLD_REF_GET_PROGRESS	= 7002,
	TOUCH_IOCTL_GLD_REF_GET_STATUS		= 7003,
...
/* mxt_fw21 chipset firmware update command */
...
/* i2c address for mxt_fw21 chipset firmware update */
...
/* -------------------------------------------------------------------- */
/* mxt_fw21 i2c slave address */
/* -------------------------------------------------------------------- */
#define MXT_FW21_I2C_ADDR       0x4A
#define MXT_FW21_I2C_BOOT_ADDR  0x24
/* -------------------------------------------------------------------- */
...
{
	uint8_t ctrl;          /*!< ctrl field reserved for future expansion */
	uint8_t reserved;          /*!< X line start position   */                           
...
typedef struct
{
	...
	uint8_t fcaldriftcoef;
	uint8_t fcaldriftlim;
...
typedef struct
{
	...
	uint8_t filtcfg;	
	uint8_t reserved1[2];
}spt_selfcaphovercteconfig_t102_config_t;

/******************************************************************************
 *       MXT_FW21 Object table init
 * *****************************************************************************/
//General Object
...
spt_dynamicconfigurationcontainer_t71_config_t dynamicconfigurationcontainer_t71_config; 
spt_touchscreenhover_t101_config_t		touchscreenhover_t101_config = {0};
spt_selfcaphovercteconfig_t102_config_t	selfcaphovercteconfig_t102_config = {0};
...
config_table_element t8_acquisition_config_table[] = { 
	...
	{(int16_t*)&acquisition_config.reserved0, UINT8},
	...
	{(int16_t*)&acquisition_config.reserved[0], UINT8},
	{(int16_t*)&acquisition_config.reserved[1], UINT8},
	{(int16_t*)&acquisition_config.reserved[2], UINT8},
};
...
config_table_element t23_proximity_config_table[] = { 
	...
	{(int16_t*)&proximity_config.reserved, UINT8},
...
config_table_element t55_adaptivethreshold_config_table[] = {
	...
	{(int16_t*)&proci_adaptivethreshold_t55_config.lowestthr, UINT8},
};

config_table_element t56_shieldless_config_table[] = {
	{(int16_t*)&proci_shieldless_t56_config.ctrl, UINT8},
	{(int16_t*)&proci_shieldless_t56_config.reserved, UINT8},
...
config_table_element t66_goldenreferences_config_table[] = {
	...
	{(int16_t*)&goldenreferences_t66_config.fcaldriftcoef, UINT8},
	{(int16_t*)&goldenreferences_t66_config.fcaldriftlim, UINT8},
};
...
config_table_element t70_dynamicconfigurationcontroller_config_table[] = {
	...
	{(int16_t*)&dynamicconfigurationcontroller_t70_config.reserved, UINT8},
...
config_table_element t101_touchscreenhover_config_table[] = {
	...
	{(int16_t*)&touchscreenhover_t101_config.yhvrthr, UINT8},
...
config_table_element t102_selfcaphovercteconfig_config_table[] = {
	{(int16_t*)&selfcaphovercteconfig_t102_config.ctrl, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.cmd, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.tunthr, UINT16},
	{(int16_t*)&selfcaphovercteconfig_t102_config.tunavgcycles, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.tuncfg, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.mode, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.prechrgtime, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.chrgtime, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.inttime, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.reserved[0], UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.reserved[1], UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.reserved[2], UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.idlesyncsperl, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.actvsyncsperl, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.driftint, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.driftst, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.driftsthrsf, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.filter, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.filtcfg, UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.reserved1[0], UINT8},
	{(int16_t*)&selfcaphovercteconfig_t102_config.reserved1[1], UINT8},
};
