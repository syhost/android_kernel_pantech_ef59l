...
//wgon test
  ...
  {
    ts_data.msc_size = tdmb_bb_read_msc(ts_data.msc_buf);
   // TDMB_MSG_DEV ("[%s] msc_size[%d]\n", __func__,ts_data.msc_size );
  }
