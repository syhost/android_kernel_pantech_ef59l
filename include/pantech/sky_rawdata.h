...
//P14994
#define PANTECH_PWR_OFF_REASON_START            (SSR_SETTING_BACKUP_START+SSR_SETTING_BACKUP_LENGTH)
#define PANTECH_PWR_OFF_REASON_LENGTH		(SECTOR_SIZE*SECTOR_SIZE_DEFAULT)


#define BACKUP_SECTOR_LENGTH                  (PANTECH_PWR_OFF_REASON_START+PANTECH_PWR_OFF_REASON_LENGTH-BACKUP_SECTOR_START)
