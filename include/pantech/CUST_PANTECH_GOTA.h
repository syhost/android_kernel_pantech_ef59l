...
#if defined(T_EF58L) || defined(T_EF59L) || defined(T_EF62L)
...
#if defined(T_EF57K) || defined(T_EF59K) || defined(T_EF61K)
// #define FEATURE_GOTA_UPDATE_INFO
// #define FEATURE_GOTA_PERMANENT_MEMORY
#define FEATURE_AIR_LOGGING
#define FEATURE_GOTA_BATTERY_WARNING
...
#if defined(T_EF56S) || defined(T_EF59S) || defined(T_EF60S) || defined(T_NAMI)
#define FEATURE_GOTA_PERMANENT_MEMORY
// #define FEATURE_GOTA_UPDATE_INFO
#define FEATURE_AIR_LOGGING
#define FEATURE_GOTA_BATTERY_WARNING
...
#if defined(T_EF58L) || defined(T_EF59L) || defined(T_EF62L) || defined(T_EF57K) || defined(T_EF59K) || defined(T_EF60S) || defined(T_EF61K) || defined(T_EF56S) || defined(T_EF59S) || defined(T_NAMI)
