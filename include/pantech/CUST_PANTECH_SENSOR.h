...
*   .Applied Files : android/vendor/qcom/proprietary/sensors/dsps/libhalsensors/src/sensors_qcom_hal.c
* ---------------------------------------------------------------*/
/* 2013-11-25 p14533 Disable feature,
   because the SBA patch for this issue is already applied.
...
*                    android/vendor/qcom/proprietary/sensors/dsps/snsutils/inc/snsutils.h
*                    android/vendor/qcom/proprietary/sensors/dsps/snsutils/src/snsutils.c
*                    android/vendor/qcom/proprietary/sensors/dsps/libhalsensors/src/sensors_qcom_hal.c
*                    android/kernel/arch/arm/mach-msm/pm-8x60.c
* ---------------------------------------------------------------*/
#define CONFIG_CHECK_HWREV_FOR_CHANGING_PROXIMITY_THRESHOLD //HANKYUNG
#endif
