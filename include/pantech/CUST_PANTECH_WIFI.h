...
12/11/16  ksg        FEATURE_SKY_WIFI_XXXXX 형태로 모든 FEATURE 수정
...
#elif defined(T_EF51L) || defined(T_EF52L) || defined(T_EF58L) || defined(EF58L) || defined(EF59L) || defined(T_EF59L) || defined(EF62L) || defined(T_EF62L)
...
//renamed as below. #define FEATURE_PANTECH_WIFI_EAP_SIM_AKA
//SKHAN_20130813 gave up this function. #define FEATURE_EAP_AKA_BY_QUALCOMM 

#define FEATURE_WIFI_LGU_EAP_AKA_IDENTITY_REQ
...
#define FEATURE_SKY_WIFI_RESTORE_CONFIG_FILE_ON_ERROR
#endif /* FEATURE_SKY_WIFI_WPA_SUPPLICANT */

#define FEATURE_WIFI_P2P_BLOCK_STORE_GROUP
...
/* When WIFI Station is connected with 2Ghz AP, the operating channel of GO Negotiation Request sets 153 Channel of 5Ghz. */
#define FEATURE_SKY_WIFI_DIRECT_OPERATING_5GH_CHANNEL

/* Initial Group Idle Timeout 0 sec For CTS Test */
#define FEATURE_WIFI_P2P_FIXED_FOR_CTS_P2P_GROUP_IDLE

/* Group Idle Timeout 20 sec ==> 1 sec */
#define FEATURE_WIFI_P2P_REDUCED_GROUP_IDLE_TIMEOUT

/* When p2p_find_timeout is happened, p2p_stop_find is not executed */
#define FEATURE_WIFI_P2P_P2P_FIND_TIMEOUT
...
#define FEATURE_SKY_WIFI_SPEEDUP_BY_SKIPPING_SCAN


#define FEATURE_SKY_WIFI_WPS_TOMBSTONE_FIX

#define FEATURE_WIFI_JNI_NULL_POINTER_EXCEPTION_FIX
...
#define FEATURE_SKY_WIFI_LGU_EAP_AKA_COMPATIBILITY

//EAP-AKA Authentication Fail Notification by Unregistered USIM
#define FEATURE_SKY_WIFI_LGU_EAP_AKA_FAIL_NOTIFICATION

#endif /* FEATURE_SKY_WIFI_VENDOR_LGU */

// @P12535, 131021, EF61K plm 00250, debug for mismtching between wpa_s->setband and bss->freq range
#define FEATURE_WIFI_SETBAND_POLICY

#define FEATURE_SKY_WIFI_CONNECT_HIDDEN_HANGUL_SSID
#define FEATURE_SKY_WIFI_REDUCE_DEBUG_MESSAGE
#define FEATURE_KT_WIFI_INITIALIZE_CONFIG_FILE
