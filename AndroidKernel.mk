...
PANTECH_PRODUCT_MODEL := $(shell echo $(SYS_MODEL_NAME) | tr A-Z a-z)
PANTECH_BOARD_VERSION := $(shell echo $(CMD_V_BD_VER) | tr A-Z a-z)
ifeq ($(PANTECH_BOARD_VERSION),)
DTS_FILES = $(wildcard $(TOP)/kernel/arch/arm/boot/dts/msm8974-v2-$(PANTECH_PRODUCT_MODEL).dts)
else
DTS_FILES = $(wildcard $(TOP)/kernel/arch/arm/boot/dts/msm8974-v2-$(PANTECH_PRODUCT_MODEL)-$(PANTECH_BOARD_VERSION).dts)
endif
else
...
# 120726 LS1-JHM modified for exFAT file system
